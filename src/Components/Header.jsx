            ...
            <div className={styles.dropdownContainer}>
              ...
              {showProducts && (
                <div className={styles.productsDropdown}>
                  <Button as={Link} to="/products/celulares" variant="link" className={`${styles.productLink} ${styles.buttonpro}`} onClick={() => setShowProducts(false)}><span>Celulares</span></Button>
                  <Button as={Link} to="/products/tablets" variant="link" className={`${styles.productLink} ${styles.buttonpro}`} onClick={() => setShowProducts(false)}><span>Tablets</span></Button>
                  <Button as={Link} to="/products/accesorios" variant="link" className={`${styles.productLink} ${styles.buttonpro}`} onClick={() => setShowProducts(false)}><span>Accesorios</span></Button>
                </div>
              )}
            </div>
            ...
            <div className={styles.dropdownContainer}>
              ...
              {showProfile && (
                <div className={styles.profileDropdown}>
                  {user ? (
                    <>
                      <Button as={Link} to="/profile" variant="link" className={`${styles.profileLink} ${styles.buttonpro}`} onClick={() => setShowProfile(false)}>
                        <span>Mi Perfil</span>
                      </Button>
                      <Button variant="link" className={`${styles.profileLink} ${styles.buttonpro}`} onClick={() => { handleLogout(); setShowProfile(false); }}>
                        <span><FaSignOutAlt /> Cerrar sesión</span>
                      </Button>
                    </>
                  ) : (
                    <>
                      <Button variant="link" className={`${styles.profileLink} ${styles.buttonpro}`} onClick={() => { handleLogin(); setShowProfile(false); }}>
                        <span>Iniciar sesión</span>
                      </Button>
                      <Button variant="link" className={`${styles.profileLink} ${styles.buttonpro}`} onClick={() => { handleRegister(); setShowProfile(false); }}>
